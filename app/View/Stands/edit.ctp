...
<?php echo $this->Form->create('Stand');?>
	<fieldset>
		<legend><?php echo __('Edit Stand'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Stand.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Stand.id'))); ?></li>
